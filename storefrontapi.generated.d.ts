...
export type UpsellProductsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type UpsellProductsQuery = {
  products: {
    nodes: Array<
...
export type UnderEyeProductQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type UnderEyeProductQuery = {
  products: {
    nodes: Array<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query UpsellProducts {\n    products(first: 10, query: "handle:the-lumive-serum-for-acne OR handle:the-lumive-aloe-vera-eye-mask") {\n      nodes {\n        id\n        title\n        handle\n        featuredImage { url altText }\n        priceRange { minVariantPrice { amount currencyCode } }\n        variants(first: 1) { nodes { id availableForSale } }\n      }\n    }\n  }\n': {
    return: UpsellProductsQuery;
    variables: UpsellProductsQueryVariables;
  };
  ...
  '#graphql\n  query UnderEyeProduct {\n    products(first: 1, query: "title:*Under-Eye*") {\n      nodes { variants(first: 1) { nodes { id } } }\n    }\n  }\n': {
    return: UnderEyeProductQuery;
    variables: UnderEyeProductQueryVariables;
  };
